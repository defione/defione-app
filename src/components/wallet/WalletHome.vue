    ...
    <div class="flex flex-col w-full">
      <div class="flex w-full space-x-4 h-60 mb-12">
        <div class="grid grid-cols-6 gap-4 w-full">
          <!-- Cards -->
          <CardWallet class="from-doneGreen to-doneBlue-light" :styleData="cardDataHarmony.style" :balanceData="cardDataHarmony.balance">
    ...
    data() {
      return {
        ...
        cardDataHarmony: {
          ...
          balance: {
            networkName: 'Harmony Chain Tokens',
            value: '9,145.39',
            valuePercentage: 59,
            assets: [
              {
              ...
              {
                icon: "https://openfi.dev/tokens/default/DONE.png",
              },
              {

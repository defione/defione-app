    ...
    <div v-if="isOpen" class="flex flex-col justify-between h-full w-full absolute">
      <div class="flex flex-col space-y-2">
        <div class="flex items-center space-x-2 mx-2">
          <i class="las la-hand-holding-usd text-xl text-doneGreen"></i>
          ...
          <div class="grid grid-cols-2 gap-3 pt-3 pb-3 px-3">
            <div class="flex h-12 space-x-2">
              ...
              <div class="flex flex-col h-full justify-between">
                <p class="text-xs text-doneBlue-light">LP Tokens Staked</p>
      ...
      <div class="flex justify-between items-center mb-0.5 h-9">
        ...
        <div class="flex items-center w-28 h-full relative">
          ...
          <transition tag="div" name="approve-btn" class="inline-block absolute">
            <div @click="unstake()" v-if="buttonState == 'active'" class="flex w-28 group-scope">
              ...
              <div class="grab-attention cursor-pointer">
                <div class="flex flex-1 items-center justify-center">
                  <p class="text-sm text-doneGreen-dark dark:text-doneGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-doneDark-gray">Unstake</p>
                </div>
                <i class="las las la-download text-xl text-doneGreen-dark dark:text-doneGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-doneDark-gray"></i>
              </div>
            </div>
          </transition> 
            ...
            <div v-if="buttonState == 'executing'" class="flex w-28 group-scope">
              ...
              <div class="grab-attention cursor-wait">
                <div class="flex flex-1 items-center justify-right">
                  <p class="text-sm text-doneGreen-dark dark:text-doneGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-doneDark-gray">Unstaking</p>
                </div>
          ...
          <!-- Unstaked -->
          <transition tag="div" name="approve-btn" class="inline-block absolute">
            <div v-if="buttonState == 'finished'" class="flex w-28 justify-between items-center border border-doneGreen glow-doneGreen-light-md space-x-1 p-2 pl-3 rounded-full dark:bg-doneDark-gray bg-gray-100 cursor-default">
              <div class="flex flex-1 items-center justify-right">
                <p class="text-sm text-doneGreen">Unstaked</p>
              </div>

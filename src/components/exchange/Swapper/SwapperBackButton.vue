<template>
  <!-- back tDone -->
  <div @click="back" class="flex h-9 items-center space-x-2 ss:space-x-0 xs:space-x-2 rounded-full group bg-gray-100 hover:bg-gray-200 dark:bg-doneDark-gray dark:hover:bg-gray-900 pr-3 ss:pr-0 xs:pr-3 cursor-pointer">
    ...
    <p class="ss:hidden xs:block text-sm text-gray-500 dark:text-doneBlue-light">back</p>
  </div>
</template>

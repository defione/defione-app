    ...
    */
    ...
    getTotalPending: async function () {
      ...
      for (var n in this.SoloPools) {
        ...
        CALL.push({
          target: MASTERCHEF,
          call: ["pendingDefione(uint256,address)(uint256)", parseInt(this.SoloPools[n].pid), userAddress],
      ...
      for (var n in this.Pools) {
        ...
        CALL.push({
          target: MASTERCHEF,
          call: ["pendingDefione(uint256,address)(uint256)", parseInt(this.Pools[n].pid), userAddress],
          returns: [["PENDING_OF_" + n, (val) => val]],
        });
      }
    ...
    generateCalls: function (pools) {
      ...
      for (var n in pools) {
        ...
        CALL.push({
          target: MASTERCHEF,
          call: ["pendingDefione(uint256,address)(uint256)", parseInt(pools[n].pid), userAddress],
          returns: [["PENDING_OF_" + n, (val) => val]],
        });

<template>
  <div id="wallet" class="max-w-screen-xl mx-auto flex flex-1 flex-col items-center done-layout xl:px-0 px-3 text-gray-500 pb-16">
    <div class="flex flex-col w-full ss:mt-3 ss:mb-6 xs:mt-8 xs:mb-12 text-gray-600 dark:text-gray-200">
      ...
      <div class="flex items-start space-x-3 mb-8">
        <i class="las la-wallet text-3xl dark:text-doneGreen text-gray-600"></i>
      ...
      <div class="flex w-full">
        ...
        <div class="flex mr-4">
          <div class="flex h-60 p-1 flex-col rounded-full shadow-xl bg-slightGray dark:bg-slightDark text-gray-500 dark:text-gray-200">
            <button @click="setActive('home')" :class="btnActive == 'home' ? 'text-doneGreen' : '' "  class="flex h-12 w-12 items-center justify-center rounded-full hover:bg-gray-700 hover:bg-opacity-10">
            ...
            <button :class="btnActive == 'staking' ? 'text-doneGreen' : 'dark:text-gray-200 text-gray-600' " @click="setActive('staking')" class="flex h-12 w-12 items-center justify-center rounded-full hover:bg-gray-700 hover:bg-opacity-10">
